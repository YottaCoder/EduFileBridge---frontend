...
const ForgotPass2 = ({ handleForgotPass1, handleForgotPass3 }) => {
    return (
            ...
            <div className="modal-content">
                <div className="modal-header">
                    <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start w-100">
                        <FontAwesomeIcon icon={faArrowLeft} className="back-arrow" onClick={ handleForgotPass1 } />
                ...
                <div className="modal-body">
                    <form>
                        ...
                        <div className="form-outline">
                            <p style={{color: 'red'}}> The One Time Password (OTP) is sent to your email. Please check your email. </p>
                        </div>
                        <div className="d-flex flex-row align-content-center justify-content-center mt-1 pt-2 mb-5">
                            <button type="button" className="btn btn-primary btn-lg" onClick={ handleForgotPass3 } style={{paddingLeft: '1.5rem', paddingRight: '1.5rem'}}>Next</button>
                        </div>
                    </form>
                </div>
            </div>
